...
Scene_OmoriTitleScreen.prototype.refreshCommandHints = function() {
  ...
  let paddingY = 4;
  let paddingX = 37;
  this._commandHints.bitmap.drawInputIcon("ok", 85, paddingX);
  this._commandHints.bitmap.drawText(confirm, iconSize + 95, paddingY, this._commandHints.bitmap.width, 85, "left");
  this._commandHints.bitmap.drawInputIcon("escape", iconSize + -42 + this._commandHints.bitmap.measureTextWidth(confirm), paddingY);
  this._commandHints.bitmap.drawText(cancel, iconSize*2 + -25 + this._commandHints.bitmap.measureTextWidth(confirm), paddingY, this._commandHints.bitmap.width, 16, "left");
}
...
Scene_OmoriTitleScreen.prototype.createTitleCommands = function() {
  ...
  this._titleCommands = [];
  // Text Array
  var textList = [' EMPEZAR ', 'CONTINUAR', 'OPCIONES']
