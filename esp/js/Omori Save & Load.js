...
Scene_OmoriFile.prototype.onSelectInputOk = function() {
  ...
  if (index === 0) {
    ...
    if (StorageManager.exists(saveFileid)) {
      // Show Prompt Window
      this.showPromptWindow('¿Sobrescribir este archivo?');
    ...
    if (StorageManager.exists(saveFileid)) {
      // Show Prompt Window
      this.showPromptWindow('¿Cargar este archivo?');
      // Set Can select Flag to false
      this._canSelect = false;
    } else {
      // Play Buzzer Sound
...
Window_OmoriFileInformation.prototype.refresh = function() {
  ...
  this.contents.drawText('ARCHIVO ' + id + ':', 10 + 30, -5, 100, this.contents.fontSize);
  // If Valid
  if (valid) {
    ...
    // Draw Level
    this.contents.drawText('NIVEL:', 290 + 55, 30, 100, 24);
    this.contents.drawText(actor.level, 290 + 55, 30, 70, 24, 'right');
    // Draw Total PlayTime
    this.contents.drawText('TIEMPO TOTAL:', 118, 55, 200, 24);
    this.contents.drawText(info.playtime, 295 + 55, 55, 100, 24);
    // Draw Location
    this.contents.drawText('UBICACIÓN:', 118, 80, 200, 24);
...
Window_OmoriFileCommand.prototype.customCursorRectXOffset = function() { return -10; }
Window_OmoriFileCommand.prototype.customCursorRectTextXOffset = function() { return 10; }
//=============================================================================
// * Setup File
//=============================================================================
...
Window_OmoriFileCommand.prototype.makeCommandList = function () {
  this.addCommand("GUARDAR", 'save', this._canSave);
  this.addCommand("CARGAR", 'load', this._canLoad);
};
