...
Window_BlackJackCommands.prototype.makeCommandList = function () {
    this.addCommand("Stay".toUpperCase(), 'stand');
    this.addCommand("Hit".toUpperCase(), 'hit');
}
...
Window_BlackJackData.prototype.refresh = function() {
    ...
    this.drawText("Dealer" + dealerStreak, 48, 32, this.windowWidth());
    this.drawText("Player" + playerStreak, 48, 196, this.windowWidth());

    this.drawText('Score: Dealer - ' + this._opponentScore + '   You - ' + this._playerScore, 0, 22, this.windowWidth() - 76, 'right');
    this.drawText('Bet: $' + SceneManager._scene._wagerAmount + ' x' + this._currentPlayerBonus + 'Total Cash - $' + this._currentEarnings, 0, 40, this.windowWidth() - 76, 'right');
...
Window_BJTitleCommands.prototype.makeCommandList = function () {
    this.addCommand("Nuevo Juego".toUpperCase(), 'new');
    this.addCommand("Continuar".toUpperCase(), 'continue', $gameVariables.value(827) >= 5);
    this.addCommand("Salir".toUpperCase(), 'quit');
}
