...
Scene_OmoBlackLetterMenu.prototype.createHangmanHeaderWindow = function() {
  ...
  this._hangmanHeaderwindow.drawBlackLetterText('EL AHORCADO', 5, 2, 26);
...
Scene_OmoBlackLetterMenu.prototype.createHangmanHeaderHelpWindow = function() {
  ...
  this._hangmanHeaderHelpwindow.drawText('Recoge las LETRAS para completar los espacios.', 5, -7, 400, 40);
  this._hangmanHeaderHelpwindow.drawText('Las LETRAS incorrectas se irán a la derecha.', 5, 15, 400, 40);
