  ...
  bgBitmap.addLoadListener(() => {
    bgBitmap50.addLoadListener(() => {
      var mapData = [
        ...
        {name: 'BOSQUE DE MOLINETES',  namePos: new Point(440, 240), rect: new Rectangle(350, 0, 99, 107), pos: new Point(471, 128),  blackSwitchId: 24, nameSwitchId: 31, blackSwitch50Id: 901 },
        {name: 'VILLA BROTE DE TIERRA', namePos: new Point(25, 340), rect: new Rectangle(450, 0, 94, 80), pos: new Point(54, 267),  blackSwitchId: 25, nameSwitchId: 32, blackSwitch50Id: 902 },
        ...
        {name: 'POZO PROFUNDO',        namePos: new Point(450, 355), rect: new Rectangle(0, 326, 418, 113), pos: new Point(119, 366),  blackSwitchId: 27, nameSwitchId: 34, blackSwitch50Id: 904 },
